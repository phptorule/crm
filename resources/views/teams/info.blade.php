<div data-ng-controller="TeamsCtrl" data-ng-init="getTeam()">
        ...
        <div class="col-sm-12">
            <div class="panel panel-bd">
                <div class="panel-heading">
                    ...
                    <div class="custom_panel_block" ng-show="teams_id">
                        <div class="custom_panel_item pull-right">
                            <a href="javascript:void(0);" ng-show=" ! edit_general" ng-click="editTeam('general')">Edytuj <i class="panel-control-icon ti-pencil"></i></a>
                        </div>
                ...
                <div class="panel-heading">
                    ...
                    <div class="custom_panel_block" ng-show="teams_id">
                        <div class="custom_panel_item pull-right" ng-show="teams_id">
                            <a href="javascript:void(0);" ng-show=" ! edit_address" ng-click="editTeam('address')">Edytuj <i class="panel-control-icon ti-pencil"></i></a>
                        </div>

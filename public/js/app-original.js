            ...
            setRoutes = function(route) {
                ...
                config = {
                  	templateUrl: function(params)
					{
						...
						{
							return '/pub/' + params.folder + '/' + params.file + '/' + params.param;
						}
						else if (params.folder && params.file)
						{
							return '/pub/' + params.folder + '/' + params.file;
						}
						else if(params.file)
						{
							return  '/pub/' + params.file;
						}
					}
				};
...
(function () {
    ...
    angular.module('app.page')
        ...
        .controller('authCtrl', ['$scope', '$window', '$location', '$http', '$timeout', 'logger', authCtrl]);
